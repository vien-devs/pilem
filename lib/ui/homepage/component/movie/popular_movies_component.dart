              ...
              children: [
                InkWell(
                  onTap: () => context.pushNamed(
                    ...
                    extra: {
                      StringResource.keyListMovieType: 'popular',
                    },
                  ),
                  ...
                  child: ListView.separated(
                    ...
                    itemBuilder: (context, index) {
                      return ItemMovieWidget(
                        imageUrl: provider.popularList[index].posterPath ?? '',
                        movieId: provider.popularList[index].id.toString(),
                      );
                    },
                  ),
                ),
