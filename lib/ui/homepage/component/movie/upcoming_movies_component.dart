              ...
              children: [
                InkWell(
                  onTap: () => context.pushNamed(
                    ...
                    extra: {
                      StringResource.keyListMovieType: 'upcoming',
                    },
                  ),
                  ...
                  child: ListView.separated(
                    ...
                    itemBuilder: (context, index) {
                      return ItemMovieWidget(
                        imageUrl: provider.upcomingList[index].posterPath ?? '',
                        movieId: provider.upcomingList[index].id.toString(),
                      );
                    },
                  ),
                ),
